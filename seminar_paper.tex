...
\bibitem{Agarwal} Occupancy-Driven Energy Management for Smart Building Automation
\bibitem{RetailStores} Effect of Traffic on Sales and Conversion Rates of Retail Stores
...
\bibitem{Xu} Xu et al. SCPL: Indoor Device-Free Multi-Subject Counting and Localization Using Radio Signal Strength
\bibitem{Xi} Xi et al. Electronic Frog Eye: Counting Crowd Using WiFi
\bibitem{Yoshida} Yoshida "Estimating the number of people using existing WiFi access point
in indoor environment"
\bibitem{OpenWrt} https://openwrt.org/
\bibitem{fcctable} https://transition.fcc.gov/oet/spectrum/table/fcctable.pdf
\bibitem{crypto} https://arstechnica.com/information-technology/2013/06/gold-in-them-bits-inside-the-worlds-most-mysterious-bitcoin-mining-company/2/
